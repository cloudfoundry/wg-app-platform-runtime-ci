...
# clone repo
git clone https://github.com/cloudfoundry/hwc.git --recursive
cd hwc
...
- `./scripts/test-in-concourse.bash <package>`: Create concourse on-off job and test all components or a single package
