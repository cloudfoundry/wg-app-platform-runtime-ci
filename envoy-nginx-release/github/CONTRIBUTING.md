...
# clone repo
git clone https://github.com/cloudfoundry/envoy-nginx-release.git --recursive
cd envoy-nginx-release
...
- `./scripts/test-in-concourse.bash`: Create concourse on-off job and test all components.
